...
namespace ReCreate_market {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class OrderDetailsDataTable : global::System.Data.TypedTableBase<OrderDetailsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OrderDetailsRow AddOrderDetailsRow(string orderid, int sno, int productid, string productname, int price, int quantity, string orderdate) {
...
namespace ReCreate_market.DataSet2TableAdapters {
    ...
    public partial class OrderDetailsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[OrderDetails] ([orderid], [sno], [productid], [productname], [" +
                "price], [quantity], [orderdate]) VALUES (@orderid, @sno, @productid, @productnam" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["Recreate_marketdbConnectionString1"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT orderid, sno, productid, productname, price, quantity, orderdate FROM dbo." +
                "OrderDetails";
        ...
        public virtual int Insert(string orderid, int sno, int productid, string productname, int price, int quantity, string orderdate) {
            if ((orderid == null)) {
