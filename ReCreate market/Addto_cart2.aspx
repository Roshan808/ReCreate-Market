<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addto_cart2.aspx.cs" Inherits="ReCreate_market.Addto_cart2" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="text-center">
                ...
                <hr />
                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-secondary" NavigateUrl="Product2.aspx">Continue Shopping</asp:HyperLink>
            </div>
